angular.module('vatraModule',[])
	.directive('ngVatra',[function(){
	return {
		restrict:'E',
		scope:{
			ngData:'=',
		...
		templateUrl:"templates/vouchers/vatra/templates/table.html",
		controller:['$scope','$modal','dmkh','dmvat','$timeout',function($scope,$modal,dmkh,dmvat,$timeout){
			...
			$scope.openDetail = function (size,template) {
				var modalInstance = $modal.open({
				  templateUrl:"templates/vouchers/vatra/templates/edit.html",
