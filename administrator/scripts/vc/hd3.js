...
hd3Module.watchDetail = function(scope){
	...
	scope.getInvoice = function(){
		...
		controller:  ['$scope', '$modalInstance','parentScope','$filter',function($scope, $modalInstance,parentScope,$filter){
				...
				$scope.loadInvoice = function(){
					$scope.masters =[];
					$scope.details=[];
					var url = server_url + "/api/" + id_app + "/getinvoice2return?ma_kh=" + $scope.ngMasterData.ma_kh;
